...
The bar fails as declared. What the count shows is that the rule being
censused is not the rule that made the readings: not one of the 94 glosses
...
## Summary
    ...
    Test 10  search replayed on null books        7 / 215 / 2 kept at three scales; no power at any; FAIL FAIL PASS
    Test 12  Test 5 rescored strict               73.7%, 8.4 sigma; +22.9 over K&T   FAIL on the leakage clause
