...
With the rendering on the page it became possible to read it, and 302
...
in the book and keep it only if it survives all of them. 716 signs are read
this way in `harness/proposals.json`, each with the folio and line of its
decisive occurrences, graded A, B, C or D. 462 are tier A, twenty of them
