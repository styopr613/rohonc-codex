...
With the rendering on the page it became possible to read it, and 260
...
in the book and keep it only if it survives all of them. 287 signs are read
this way in `harness/proposals.json`, each with the folio and line of its
decisive occurrences, graded A, B, C or D. 123 are tier A, twenty of them
