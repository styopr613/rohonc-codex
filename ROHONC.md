...
With the rendering on the page it became possible to read it, and 254
...
in the book and keep it only if it survives all of them. 274 signs are read
this way in `harness/proposals.json`, each with the folio and line of its
decisive occurrences, graded A, B, C or D. 114 are tier A, twenty of them
