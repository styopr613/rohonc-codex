...
def main():
    ...
    check("proposals: 3591 lines fully read with them",
          len(g) == 2 and g[0] == 3591 and close(g[1], 82.1, .02), str(g))
    ...
    check("ROHONC: METHOD.md and the readings are stated",
          "METHOD.md" in flat and "1251 signs are read" in flat
          and "23.8% to **82.1%**" in flat)
