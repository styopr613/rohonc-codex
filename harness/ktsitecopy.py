...
data_lead        one or two sentences: the data is in the repository at https://github.com/SUP613/rohonc-codex; this page names the reference corpus and says where everything else goes. No file links
