...
## Test 12 — Test 5 rescored under a strict rule, with outside readers
...
asked what the blank must mean.
    ...
    Gemini 2.5 Pro        26 / 38  68%        7             84%
    Grok 4.7              27 / 38  71%        3             77%
...
## Summary
    ...
    Test 2   part of speech                      instrument fails on K&T's own words   NO VERDICT
    Test 3   blindfold, run clean                 4 of 24 strict, 16.7%; band 15-30%, consequence reaffirmed
    Test 7   K&T's words removed                 reads 11.9% from ours alone (by design: they extend the dictionary); recovery 4.4 sigma against a declared 5, FAIL
    Test 8   bootstrap from a random 30%          passage 33.9 sigma (8.4% absolute), recovery 8.5 sigma (0.9% absolute)   PASS
    Test 9   hidden 70% validated by the 30%       A+B 11.3 sigma, 130% of K&T's own rate   PASS

    After the outside review, same day:
    Test 11  passage map from K&T's words alone   median rank 25 of 1334, top-1 12.4%, p 2e-28   PASS
    Test 10  search replayed on null books        7 / 215 / 2 kept at three scales; the count rule has no power at any   NO VERDICT
             held-out, same runs                  real 8 sigma over shuffle, null books none
